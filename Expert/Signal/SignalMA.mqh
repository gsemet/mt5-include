      ...
      if(IS_PATTERN_USAGE(1) && DiffOpenMA(idx)>0.0 && DiffMA(idx)>0.0)
        {
         ...
         m_base_price=0.0;
         printf(__FUNCTION__ + "long condition pattern 1");
        }
     }
   else
     {
            ...
            if(IS_PATTERN_USAGE(2))
              {
               ...
               printf(__FUNCTION__ + "long condition pattern 2");
              }
           }
         else
           {
            ...
            if(IS_PATTERN_USAGE(3) && DiffLowMA(idx)<0.0)
              {
               ...
               m_base_price=0.0;
               printf(__FUNCTION__ + "long condition pattern 3");
              }
           }
        }
     }
      ...
      if(IS_PATTERN_USAGE(1) && DiffOpenMA(idx)<0.0 && DiffMA(idx)<0.0)
        {
         ...
         //--- consider that this is an unformed "piercing" and suggest to enter the market at the current price
         m_base_price=0.0;
         printf(__FUNCTION__ + "short condition pattern 1");
        }
     }
   else
     {
            ...
            if(IS_PATTERN_USAGE(2))
              {
               ...
               //--- suggest to enter the market at the "roll back"
               m_base_price=m_symbol.NormalizePrice(MA(idx));
               printf(__FUNCTION__ + "short condition pattern 2");
              }
           }
         else
           {
            ...
            if(IS_PATTERN_USAGE(3) && DiffHighMA(idx)>0.0)
              {
               ...
               //--- consider that this is a formed "piercing" and suggest to enter the market at the current price
               m_base_price=0.0;
               printf(__FUNCTION__ + "short condition pattern 3");
              }
           }
        }
     }
